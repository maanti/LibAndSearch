 ...
 */
import static com.praktos.tikoLuceneSearch.constants.Constants.PATH_TO_INDEX_FOLDER;
public class DocumentIndexer {
    ...
    public void index(final Boolean create, List<Document> documents, Analyzer analyzer) throws IOException {
        final Directory dir = FSDirectory.open(Paths.get(PATH_TO_INDEX_FOLDER));
    ...
    /**
     * Get IndexReader by using PATH_TO_INDEX_FOLDER
     *
